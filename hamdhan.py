...
def ressture():
   ...
   import getpass
   sandi = raw_input('║PW      : ')
   if sandi == 'channel MUSIC' and user == 'HAMDAN':
      print '║LOGIN SUKSES\n╚═══════\x1b[1;91m▶'
      sys.exit
   else:
...
def lodhirt():
    lodhirt = [
     'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', 'HAMDAN MUSIC', '      ', HAMDAN MUSIC'\n']
    for o in lodhirt:
...
print '║\033[1;37m{\033[1;33m3\033[1;37m} \033[1;34mInstall Bahan Dulu Bro\033[1;37m'
...
if pilih == 1:
	...
	os.system('xdg-open https://adsafelink.com/hWB7qIj2Y')
elif pilih == 0:
	os.system('clear')
